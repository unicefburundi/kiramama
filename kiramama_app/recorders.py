    ...
    if len(vac_notification_types) > 0:
        for notification_type in vac_notification_types:
            ...
            if len(vaccination) > 0:
                ...
                random_delivery_date_time = datetime.datetime.combine(
                    delivery_date, datetime.datetime.now().time()
                )
                weeks_after_birth_for_vacc = int(
                    vaccination.received_after_how_many_weeks
                )
                approximative_date_for_vaccination = (
                    random_delivery_date_time
                    + datetime.timedelta(weeks=weeks_after_birth_for_vacc)
                )

                # Let's check if this kind of reminder is sent to CHWs
                notifications_for_chw = NotificationsForCHW.objects.filter(
                ...
                if len(notifications_for_chw) > 0:
                    ...
                    if time_measure_unit.code.startswith(
                        ...
                        time_for_reminder = (
                            approximative_date_for_vaccination
                            - datetime.timedelta(minutes=number_for_time)
                        )
                    if time_measure_unit.code.startswith(
                        "h"
                        ...
                        time_for_reminder = (
                            approximative_date_for_vaccination
                            - datetime.timedelta(hours=number_for_time)
                        )
                    ...
                    if (
                        ...
                        remind_message_to_send_to_chw = remind_message_to_send_to_chw.replace(
                            notification_for_chw.word_to_replace_by_the_date_in_the_message_to_send,
                            approximative_date_for_vaccination.date().isoformat(),
                        )
                ...
                notifications_for_mother = NotificationsForMother.objects.filter(
                    notification_type=notification_type
                )
...
def check_supervisor_phone_number_not_for_this_contact(args):
    ...
    if args["text"].split(" ")[4] in args["phone"]:
        ...
        args["info_to_contact"] = (
            "Ikosa. Wanditse inomero ya telefone yawe mu kibanza c inomero ya telefone yuwugukurikirana. Kosora mu kurungika kandi ubutumwa butangurwa na '"
            + args["mot_cle"]
            + "' ushiremwo n inomero ya telefone yukuri yuwugukurikirana"
        )
    else:
        args["valide"] = True
...
def check_if_is_reporter(args):
    ...
    if len(concerned_reporter) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Ntiwiyandikishije kugira ushobore gutanga raporo. Kugira ushobore gutanga ama raporo, banza wiyandikishe mu kurungika mesaje yo kwiyandikisha itangurwa nakajambo REG"
        return
    ...
    if not one_concerned_reporter.cds:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Votre site n est pas enregistre dans le systeme. Veuillez contacter l administrateur du systeme"
        return
...
def check_number_of_values_ris(args):
    ...
    if (len(args["text"].split(" ")) != number_of_values_for_a_child) and (
        len(args["text"].split(" ")) != number_of_values_for_a_woman
    ):
        args["valide"] = False
        ...
        args["info_to_contact"] = (
            "Ikosa. Igitigiri civyo warungitse sico. Gitegerezwa kuba '"
...
def check_is_future_date(args):
    ...
    if re.search(expression, given_date) is None:
        ...
        args["info_to_contact"] = (
            "Ikosa. '"
            + args["date_meaning"]
            + "' siyo. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
    ...
    try:
        ...
        args["info_to_contact"] = (
            "Ikosa. '"
            + args["date_meaning"]
            + "' watanze siryo. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
    ...
    if date_sent <= datetime.datetime.now().date():
        ...
        args["info_to_contact"] = (
            "Ikosa. '"
            + args["date_meaning"]
            + "' ryararenganye. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
...
def check_is_past_date(args):
    ...
    if date_sent > datetime.datetime.now().date():
        ...
        args["info_to_contact"] = (
            "Ikosa. '"
            + args["date_meaning"]
            + "' watanze ntiribaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
...
def check_date_is_previous_or_today(args):
    ...
    if date_sent > datetime.datetime.now().date():
        ...
        args["info_to_contact"] = (
            "Ikosa. '"
            + args["date_meaning"]
            + "' watanze ntirirabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
...
def check_risk_level(args):
    ...
    if len(risk_levels) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico watanze cerekana uko umuvyeyi amerewe ntikizwi. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_location(args):
    ...
    locations = Lieu.objects.filter(
        location_category_designation__iexact=location_to_check
    )
    if len(locations) < 1:
        args["valide"] = False
...
def check_phone_number(args):
    ...
    if re.search(expression, phone_number_to_check_no_space) is None:
        ...
        args["info_to_contact"] = (
            "Ikosa. Inomero ya telefone ntiyanditse neza. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_if_is_reporter(args):
    ...
    if len(concerned_chw) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Ntiwiyandikishije kugira ushobora gutanga ama raporo. Usabwe kubanza kwiyandikisha mu kurungika ya mesaje itangurwa na 'REG'"
        return
...
def check_if_contact_is_from_hf(args):
    ...
    if len(concerned_chw) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Inomero ya telefone yawe ntidushoboye kuyimenya. Kugira itange ubwo butumwa iba yaranditswe numuremesha kiyago ariko ariyandikisha."
        return
...
def check_mother_id_is_valid(args):
    ...
    if len(filtered_mother) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta muvyeyi abaho afise iyo numero wanditse. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_mother_is_affected_somewhere(args):
    ...
    if not args["concerned_mother"].is_affected_somewhere:
        ...
        args["info_to_contact"] = (
            ...
            + "' ntituzi aho ubu aba. Nimba aba aho ukorera, banza ubimenyeshe mu kurungika mesaje itangurwa nakajambo 'REC' yanditse neza"
        )
    else:
        args["valide"] = True
        args["info_to_contact"] = (
            "Aho umupfasoni '" + args["concerned_mother"].id_mother + "' aba harazwi"
        )
...
def check_mother_has_ris_report(args):
    ...
    if len(mother_set) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta mesaje irigire irungikwa ivuga ukutamererwa neza kw umuvyeyi nomero '"
            + args["concerned_mother"].id_mother
            + "'"
        )
    else:
        args["valide"] = True
        the_concerned_ris = ReportRIS.objects.filter(
            report__mother=args["concerned_mother"]
        ).order_by("-id")[0]
...
def check_cpn_name_exists(args):
    ...
    if len(filtered_cpn) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ibiranga CPN wanditse ntibibaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_cpn_order_respected(args):
    ...
    the_last_cpns_for_this_mother = (
        ReportCPN.objects.filter(report__mother=args["concerned_woman"])
        .order_by("id")
        .reverse()
    )
    ...
    if len(the_last_cpns_for_this_mother) > 0:
        ...
        the_last_cpn_number_for_this_mother = the_last_cpns_for_this_mother[
            0
        ].concerned_cpn.cpn_number
    ...
    if the_sent_cpn_number != the_expected_cpn_number:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Iyo raporo CPN utanze siyo yari yitezwe kuri uwo mupfasoni."
        return
...
def check_is_float(args):
    ...
    if re.search(expression, value_to_check) is None:
        ...
        args["valide"] = True
        args["info_to_contact"] = (
            "La valeur envoyee pour '" + args["date_meaning"] + "' est valide."
        )
...
def check_child_code(args):
    ...
    child_numbers = ChildNumber.objects.filter(
        child_code_designation=the_sent_child_code
    )
    ...
    if len(child_numbers) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Wanditse inomero yumwana itabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_child_code_order(args):
    ...
    if args["child_code"] != "01":
        ...
        previous_child_numbers = ChildNumber.objects.filter(
            child_number=previous_child_number
        )
        if len(previous_child_numbers) < 1:
            args["valide"] = False
            args[
                "info_to_contact"
            ] = "Exception. Un 'ChildNumber' qui precede le courant n est pas trouve"
            return
        ...
        nsc_with_the_previous_child_number = ReportNSC.objects.filter(
            report__mother=args["concerned_woman"],
            child_number=one_concerned_previous_child_number,
        )
        if len(nsc_with_the_previous_child_number) < 1:
            # The previous child number not used
            args["valide"] = False
            args["info_to_contact"] = (
                "Ikosa. Inomero z abana zitegerezwa gukoreshwa ku murongo. Inomero '"
                + one_concerned_previous_child_number.child_code_designation
                + "' iza imbere ya '"
                + args["child_code"]
                + "'"
            )
...
def check_allaitement_maternel(args):
    ...
    allaitements = BreastFeed.objects.filter(
        breast_feed_option_name__iexact=the_sent_value
    )
    if len(allaitements) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico wanditse kuvyerekeye 'Igihe umwana yonkerejweko ubwa mbere' ntikibaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_gender(args):
    ...
    if len(genders) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico wanditse kuvyerekeye 'Igitsina c umwana' sivyo. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
        ...
        args[
            "info_to_contact"
        ] = "La valeur envoyee pour le genre du nouveau nee est valide"
...
def check_child_exists(args):
    ...
    child_numbers = ChildNumber.objects.filter(
        child_code_designation__iexact=the_sent_child_number
    )
    if len(child_numbers) < 1:
        args["valide"] = False
        ...
        args["info_to_contact"] = (
            "Ikosa. Inomero y umwana wanditse ntibaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
    ...
    birth_reports_with_this_mother_and_childcode = ReportNSC.objects.filter(
        report__mother=args["concerned_mother"], child_number=child_number
    )
    ...
    if len(birth_reports_with_this_mother_and_childcode) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Umupfasoni nomero '"
            + args["concerned_mother"].id_mother
            + "' nta mwana nomero '"
            + the_sent_child_number
            + "' afise. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_con_code(args):
    ...
    if len(con_codes) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico wanditse ku vyerekeye 'incuro umuvyeyi yagiriye kw ivuriro inyuma yo kwibaruka' sico. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
    ...
    for current_symptom in sent_symptoms_list:
        if valid is True:
            symptoms = Symptom.objects.filter(
                symtom_designation__iexact=current_symptom
            )
            if len(symptoms) < 1:
                valid = False
                ...
                if first_symptom:
                    symptoms_kirundi_names = (
                        symptoms_kirundi_names + "" + kir_symptom_name
                    )
                    first_symptom = False
                else:
                    symptoms_kirundi_names = (
                ...
                if one_symptom.is_red_symptom:
                    if red_first_symptom:
                        red_symptoms_kirundi_names = (
                            red_symptoms_kirundi_names + "" + kir_symptom_name
                        )
...
def check_health_status(args):
    ...
    health_status_group = HealthStatus.objects.filter(
        health_status_desigantion__iexact=sent_health_status_value
    )
    ...
    if len(health_status_group) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico warungitse kuvyerekeye '"
            + args["health_status_meaning"]
            + "' ntikibaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        ...
        args["valide"] = True
        args["info_to_contact"] = (
            "La valeur envoyee pour '" + args["health_status_meaning"] + "' est valide"
        )
...
def check_rescue_received(args):
    ...
    rescue_received_set = Rescue.objects.filter(
        rescue_designation__iexact=sent_rescue_received_value
    )
...
def check_vac_code(args):
    ...
    concerned_vac_code_objects = VAC.objects.filter(
        vac_designation__iexact=sent_vaccine_code
    )
    ...
    if len(concerned_vac_code_objects) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Ico warungitse kuvyerekeye 'urucanco rwagizwe' ntikibaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
        ...
        args[
            "info_to_contact"
        ] = "Le code envoye pour la vaccination effectuee est valide"
...
def check_mother_id_is_valide(args):
    ...
    if len(concerned_mother) < 1:
        ...
        # args['info_to_contact'] = "Erreur. Une maman avec cet identifiant n existe pas dans le systeme. Pour corriger, veuillez reenvoyer un message corrige et commencant par le mot cle "+args['mot_cle']
        args["info_to_contact"] = (
            "Ikosa. Umuvyeyi afise iyo numero uhejeje gutanga ntabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_facility(args):
    ...
    if len(concerned_facility) > 0:
        ...
        args["info_to_contact"] = (
            "Ikosa. Wanditse inomero y ivuriro itabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
...
def check_supervisor_phone_number(args):
    ...
    if re.search(expression, the_supervisor_phone_number_no_space) is None:
        ...
        args["info_to_contact"] = (
            "Ikosa. Wanditse nabi inomero ya telefone yuwugukurikirana. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def save_temporary_the_reporter(args):
    ...
    if len(same_existing_temp) > 0:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Wari wasabwe kurungika inomero ya telefone yuwugukurikirana gusa. Mu gukosora subira utangure kwiyandikisha"
    else:
        ...
        if len(facility) > 0:
            ...
            if len(the_hill) < 1:
                ...
                args[
                    "info_to_contact"
                ] = "Ikosa. Izina ryumusozi wanditse ntiribaho. Mu gukosora, subira urungike iyo mesaje itangurwa na 'REG' yanditse neza"
                return
            ...
            if len(the_sub_hill0) < 1:
                ...
                args[
                    "info_to_contact"
                ] = "Ikosa. Izina ryagacimbiri wanditse ntiribaho . Mu gukosora, subira urungike iyo mesaje itangurwa na 'REG' yanditse neza"
                return
            # If the sub hill name sent by the reporter exist in the system, let's check if it's linked to the specified hill
            the_sub_hill1 = SousColline.objects.filter(
                name__iexact=the_sub_hill_name, colline=the_concerned_hill
            )
            if len(the_sub_hill1) < 1:
                ...
                args["info_to_contact"] = (
                    "Ikosa. Nta gacimbiri kabaho kitwa '"
                    + args["text"].split(" ")[3].title()
                    + "' ku mutumba '"
                    + args["text"].split(" ")[2].title()
                    + "'. Mu gukosora, subira urungike iyo mesaje itangurwa na 'REG' yanditse neza"
                )
                return
            ...
            args[
                "info_to_contact"
            ] = "Rungika inomero ya terefone y uwugukurikirana yonyene atakindi ugeretseko kugira iyandikwa ryawe riherahezwe."
...
def check_has_already_session(args):
    ...
    if len(same_existing_temp) > 0:
        ...
        # args['info_to_contact'] = "Erreur. Vous devriez envoyer le numero de telephone de votre superviseur seulement. Pour corriger, veuillez recommencer l enregistrement."
        args["info_to_contact"] = (
            "Ikosa. Wari wasabwe kurungika numero ya telefone yuwugukurikirana gusa. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
    else:
...
def check_risk_report_exists_for_given_woman(args):
    ...
    concerned_risk_reports = ReportRIS.objects.filter(
        report__mother=the_concerned_woman
    )
    if len(concerned_risk_reports) > 0:
        ...
        args[
            "info_to_contact"
        ] = "Ikosa. Nta muremesha kiyago ararungika mesaje ivuga ko umupfasoni afise iyo numero agwaye."
...
def temporary_record_reporter(args):
    ...
    if args["text"].split(" ")[0].upper() == "REG":
        ...
        if args["valide"] is True:
            ...
            args[
                "info_to_contact"
            ] = "Ikosa. Warahejeje kwiyandikisha. Nimba harico ushaka guhindira kukuntu wiyandikishije, rungika mesaje yo guhubura itangurwa na 'REGM'"
            return
...
def complete_registration(args):
    ...
    if len(the_existing_temp) < 1:
        ...
        if (
            ...
            check_duplication = CHW.objects.filter(
            ...
            if is_first_registration:
                CHW.objects.create(
                    phone_number=the_one_existing_temp.phone_number,
                    cds=the_one_existing_temp.facility,
                    supervisor_phone_number=the_one_existing_temp.supervisor_phone_number,
                    sub_colline=the_one_existing_temp.sub_hill,
                )
                ...
                args["info_to_contact"] = (
                    "Iyandikwa ryawe rigenze neza. [Ivuriro : '"
                    + the_one_existing_temp.facility.name
                    + "', Umutumba :  '"
                    + the_one_existing_temp.sub_hill.colline.name
                    + "', Agacimbiri : '"
                    + the_one_existing_temp.sub_hill.name
                    + "']. Wihenze, kosora urungitse mesaje yanditse neza itangurwa na 'REGM'"
                )
            else:
                ...
                the_existing_contact.supervisor_phone_number = (
            ...
            args[
                "info_to_contact"
            ] = "Ikosa. Warungitse inomero ya telefone yuwugukurikirana ukuntu kubiri gutandukanye. Mu gukosora subira urungike mesaje itangurwa na 'REG' yanditse neza"
...
def record_pregnant_case(args):
    ...
    gro_reports_from_this_cds = Report.objects.filter(
        cds=args["facility"], category=args["mot_cle"]
    )
    ...
    if len(gro_reports_from_this_cds) > 0:
        the_last_mother_from_this_cds = (
            Report.objects.filter(cds=args["facility"], category=args["mot_cle"])
            .order_by("-id")[0]
            .mother
        )
    ...
    created_gro_report = ReportGRO.objects.create(
        ...
        expected_delivery_date=args["expected_birth_date"],
        next_appointment_date=args["next_appointment_date"],
        risk_level=args["risklevel"],
        consultation_location=args["location"],
    )
    ...
    if len(cpn2_notification_type) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. L administrateur du systeme n a pas cree la notification 'CPN2' dans la base de donnees."
        return

    # -----------------
    next_appointment_date_time = datetime.datetime.combine(
        args["next_appointment_date"], datetime.datetime.now().time()
    )
    ...
    notifications_for_mother = NotificationsForMother.objects.filter(
        notification_type=the_cpn2_notification_type
    )
    if len(notifications_for_mother) > 0:
        notification_for_mother = notifications_for_mother[0]
        ...
        if time_measure_unit.code.startswith("m") or time_measure_unit.code.startswith(
            "M"
        ):
            time_for_reminder = next_appointment_date_time - datetime.timedelta(
                minutes=number_for_time
            )
        if time_measure_unit.code.startswith("h") or time_measure_unit.code.startswith(
            "H"
        ):
            time_for_reminder = next_appointment_date_time - datetime.timedelta(
        ...
        if notification_for_mother.word_to_replace_by_the_date_in_the_message_to_send:
            remind_message_to_send_to_mother = remind_message_to_send_to_mother.replace(
                notification_for_mother.word_to_replace_by_the_date_in_the_message_to_send,
                next_appointment_date_time.date().isoformat(),
            )
    ...
    if len(notifications_for_chw) > 0:
        ...
        if notification_for_chw.word_to_replace_by_the_mother_id_in_the_message_to_send:
            remind_message_to_send_to_chw = remind_message_to_send_to_chw.replace(
                notification_for_chw.word_to_replace_by_the_mother_id_in_the_message_to_send,
                the_created_mother_record.id_mother,
            )
    ...
    if len(acc_notification_type) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. L administrateur du systeme n a pas cree la notification 'acc' dans la base de donnees."
        return

    # -----------------
    expected_delivery_date_time = datetime.datetime.combine(
        args["expected_birth_date"], datetime.datetime.now().time()
    )
    # -----------------
    ...
    notifications_for_mother = NotificationsForMother.objects.filter(
        notification_type=the_acc_notification_type
    )
    if len(notifications_for_mother) > 0:
        for notification_for_mother in notifications_for_mother:
            ...
            if time_measure_unit.code.startswith(
                ...
                time_for_reminder = expected_delivery_date_time - datetime.timedelta(
                    minutes=number_for_time
                )
            if time_measure_unit.code.startswith(
                "h"
            ...
            if (
                ...
                remind_message_to_send_to_mother = remind_message_to_send_to_mother.replace(
                    notification_for_mother.word_to_replace_by_the_date_in_the_message_to_send,
                    expected_delivery_date_time.date().isoformat(),
                )
...
def modify_record_pregnant_case(args):
    ...
    the_corresponding_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_corresponding_report) < 1:
        args["valide"] = False
        args[
            "info_to_contact"
        ] = "Exception. Un rapport de categorie 'GRO' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    the_one_corresponding_report = the_corresponding_report[0]

    the_corresponding_gro_report = ReportGRO.objects.filter(
        report=the_one_corresponding_report
    )
    if len(the_corresponding_gro_report) < 1:
        args["valide"] = False
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'GRO' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    the_one_corresponding_gro_report.expected_delivery_date = args[
        "expected_birth_date"
    ]
    the_one_corresponding_gro_report.next_appointment_date = args[
    ...
    args["info_to_contact"] = (
        "Mesaje yo gukosora iyari yatanzwe ivuga ko umupfasoni nomero '"
        + args["concerned_mother"].id_mother
        + "' yibungenze yashitse neza."
    )
...
def record_prenatal_consultation_report(args):
    ...
    created_cpn_report = ReportCPN.objects.create(
        report=the_created_report,
        concerned_cpn=args["concerned_cpn"],
        consultation_date=args["cpn_consultation_date"],
        consultation_location=args["location"],
        mother_weight=checked_value,
        next_appointment_date=args["next_appointment_date"],
    )
    ...
    args["info_to_contact"] = (
        "Mesaje '"
        + args["concerned_cpn"].cpn_designation
        + "' warungitse yerekeye umupfasoni '"
        + args["concerned_woman"].id_mother
        + "' yashitse."
    )
...
def modify_record_prenatal_consultation_report(args):
    ...
    the_existing_cpn_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_cpn_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'CPN' iratangwa yerekeye umupfasoni '"
            + args["concerned_mother"].id_mother
            + "'. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return

    the_only_one_corresponding_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    ).order_by("-id")[0]

    the_corresponding_cpn_report = ReportCPN.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_cpn_report) < 1:
        args["valide"] = False
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'CPN' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    the_one_corresponding_cpnreport.next_appointment_date = args[
        "next_appointment_date"
    ]
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yarungitswe yerekeye ukuja gupimisha imbanyi kwumupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse."
    )
...
def record_birth_case_report(args):
    ...
    created_nsc_report = ReportNSC.objects.create(
        ...
        gender=args["gender"],
        weight=checked_value,
        next_appointment_date=args["next_cpon_appointment_date"],
    ...
    if len(con1_notification_type) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. L administrateur du systeme n a pas cree la notification 'CON1' dans la base de donnees."
        return

    # -----------------
    next_appointment_date_time = datetime.datetime.combine(
        args["next_cpon_appointment_date"], datetime.datetime.now().time()
    )
    ...
    notifications_for_mother = NotificationsForMother.objects.filter(
        notification_type=the_con1_notification_type
    )
    if len(notifications_for_mother) > 0:
        notification_for_mother = notifications_for_mother[0]
...
def modify_record_birth_case_report(args):
    ...
    the_existing_nsc_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_nsc_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo yigeze itangwa ivuga ko umuvyeyi nomero '"
            + args["concerned_mother"].id_mother
            + "' yibarutse. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
    ...
    the_corresponding_nsc_report = ReportNSC.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_nsc_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'NSC' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    the_one_corresponding_nscreport.next_appointment_date = args[
        "next_cpon_appointment_date"
    ]
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yatanzwe yerekeye umwana '"
        + args["child_number"].child_code_designation
        + "' w umupfasoni '"
        + args["concerned_woman"].id_mother
        + "' yashitse"
...
def record_postnatal_care_report(args):
    ...
    created_con_report = ReportCON.objects.create(
        report=the_created_report,
        child=args["concerned_child"],
        con=args["concerned_con"],
        child_health_state=args["child_s_health_state"],
        mother_health_state=args["mother_s_health_state"],
        next_appointment_date=args["next_appointment_date"],
    )

    for one_symbol in args["checked_symptoms_list"]:
        one_symptom = Symptom.objects.filter(symtom_designation__iexact=one_symbol)[0]
        created_report_symptom_connection = CON_Report_Symptom.objects.create(
            con_report=created_con_report, symptom=one_symptom
        )
    ...
    if args["concerned_con"].con_designation.upper() == "CON1":
        ...
        if len(con2_notification_type) < 1:
            ...
            args[
                "info_to_contact"
            ] = "Exception. L administrateur du systeme n a pas cree la notification 'CON2' dans la base de donnees."
            return
        ...
        notifications_for_mother = NotificationsForMother.objects.filter(
            notification_type=the_con2_notification_type
        )
        if len(notifications_for_mother) > 0:
            notification_for_mother = notifications_for_mother[0]
    ...
    args["info_to_contact"] = (
        "Mesaje warungitse yerekeye ukuja kwivuriro kw umwana '"
        + args["child_number"].child_code_designation
        + "' w umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse"
...
def modify_record_postnatal_care_report(args):
    ...
    the_existing_con_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_con_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'CON' yumuvyeyi nomero '"
            + args["concerned_mother"].id_mother
            + "' irabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return
    ...
    the_corresponding_con_report = ReportCON.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_con_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'CON' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    the_one_corresponding_conreport.next_appointment_date = args[
        "next_appointment_date"
    ]
    the_one_corresponding_conreport.save()

    # Let's update 'CON_Report_Symptom' connections
    concerned_con_report_symptom_connections = CON_Report_Symptom.objects.filter(
        con_report=the_one_corresponding_conreport
    )
    ...
    for one_symbol in args["checked_symptoms_list"]:
        one_symptom = Symptom.objects.filter(symtom_designation__iexact=one_symbol)[0]
        created_report_symptom_connection = CON_Report_Symptom.objects.create(
            con_report=the_one_corresponding_conreport, symptom=one_symptom
        )
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yatanzwe yerekeye ukuja kw ivuriro kw umwana '"
        + args["child_number"].child_code_designation
        + "' w umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse"
...
def record_child_follow_up_report(args):
    ...
    created_vac_report = ReportVAC.objects.create(
        report=the_created_report,
        child=args["concerned_child"],
        vac=args["concerned_vac"],
    ...
    args["info_to_contact"] = (
        "Mesaje yerekeye ikurikiranwa ry umwana '"
        + args["child_number"].child_code_designation
        + "' w umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse neza"
...
def modify_record_child_follow_up_report(args):
    ...
    the_existing_vac_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_vac_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'VAC' yumuvyeyi numero '"
            + args["concerned_mother"].id_mother
            + "' irabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
    ...
    the_corresponding_vac_report = ReportVAC.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_vac_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'VAC' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yatanzwe yerekeye ikurikiranwa ry umwana '"
        + args["child_number"].child_code_designation
        + "' w umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse neza"
...
def record_risk_report(args):
    ...
    if args["ris_type"] == "RIS_CHILD":
        ...
        report_ris_bebe = ReportRISBebe.objects.create(
            ris_report=created_ris_report, concerned_child=args["concerned_child"]
        )
    ...
    if args["ris_type"] == "RIS_CHILD":
        ...
        args["info_to_contact"] = (
            "Mesaje warungitse yerekeye ibimenyetse vy indwara kumwana '"
            + args["child_number"].child_code_designation
            + "' w umupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse neza"
        ...
        args["info_to_supervisors"] = (
            ...
            + "' w umupfasoni nomero '"
            + args["concerned_mother"].id_mother
            + "', akurikiranwa n umuremesha kiyago '"
            + args["the_sender"].phone_number
            + "', wo mu gacimbiri '"
            + args["sub_colline"].name
            + "' afise ikimenyetso mburizi : "
            + args["kirundi_red_symptoms_names"]
        )

    if args["ris_type"] == "RIS_WOMAN":
        # args['info_to_contact'] = "Le rapport de risque de la maman '"+args['concerned_mother'].id_mother+"' est bien enregistre."
        args["info_to_contact"] = (
            "Mesaje warungitse yerekeye ibimenyetso vy indwara ku mupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse neza"
        )
    ...
    if len(args["kirundi_red_symptoms_names"]) > 1:
        ...
        if args["ris_type"] == "RIS_CHILD":
            args["info_to_supervisors"] = (
                ...
                + args["sub_colline"].name
                + "' ko muri '"
                + args["the_sender"].cds.name
                + "', '"
                + args["the_sender"].cds.district.name
                + "', BPS '"
                + args["the_sender"].cds.district.bps.name
                + "' afise ikimenyetso mburizi : "
                + args["kirundi_red_symptoms_names"]
            )
...
def record_mother_arrived_at_hf(args):
    ...
    args["info_to_contact"] = (
        "Ubutumwa uhejeje kurungika buvuga ko umupfasoni afise inomero "
        + args["sent_mother_id"]
        + " yashitse kw ivuriro bwashitse neza."
    )

    args["info_to_supervisors"] = (
        "Umuntu akoresheje nomero ya telephone "
        + args["phone"]
        + " amenyesheje ko umupfasoni afise inomero "
        + args["sent_mother_id"]
        + " yashitse kw ivuriro."
    )
...
def modify_record_risk_report(args):
    ...
    the_existing_ris_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_ris_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'RIS' yumuvyeyi '"
            + args["concerned_mother"].id_mother
            + "' irabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
    ...
    the_corresponding_ris_report = ReportRIS.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_ris_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'RIS' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    all_ris_report_symptom_connections = RIS_Report_Symptom.objects.filter(
        ris_report=the_one_corresponding_risreport
    )
    ...
    if args["ris_type"] == "RIS_CHILD":
        # Let's record informations related to the child
        report_ris_bebe = ReportRISBebe.objects.get_or_create(
            ris_report=the_one_corresponding_risreport,
            concerned_child=args["concerned_child"],
        )
    ...
    if args["ris_type"] == "RIS_CHILD":
        ...
        args["info_to_contact"] = (
            "Mesaje ikosora iyari yarungitswe yerekeye ibimenyetso vy indwara kumwana '"
            + args["child_number"].child_code_designation
            + "' w umupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse neza"
    ...
    if args["ris_type"] == "RIS_WOMAN":
        ...
        args["info_to_contact"] = (
            "Mesaje ikosora iyari yarungitswe yerekeye ibimenyetso vy indwara ku mupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse neza"
        )
        args["info_to_supervisors"] = (
            "Mesaje yo gukosora. Umupfasoni nomero '"
            + args["concerned_mother"].id_mother
            + "', akurikiranwa n umuremesha kiyago '"
            + args["the_sender"].phone_number
            + "', wo mu gacimbiri '"
...
def record_response_to_risk_report(args):
    ...
    created_rer_report = ReportRER.objects.create(
        report=the_created_report,
        ris=args["the_concerned_ris"],
        rescue=args["concerned_rescue_received"],
        current_state=args["concerned_health_status"],
    )
    ...
    args["info_to_contact"] = (
        "Mesaje ivuga icakozwe ku vyerekeye ibimenyetso vy indwara vyabonetse ku mupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse neza"
    )
...
def modify_record_response_to_risk_report(args):
    ...
    the_existing_rer_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_rer_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'RER' yumuvyeyi '"
            + args["concerned_mother"].id_mother
            + "' irabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
    ...
    the_corresponding_rer_report = ReportRER.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_rer_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'RER' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yatanzwe ivuga icakozwe ku vyerekeye ibimenyetso vy indwara vy abonetse ku mupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse neza"
    )
...
def record_death_report(args):
    ...
    created_dec_report = ReportDEC.objects.create(
        report=the_created_report,
        location=args["location"],
        death_code=args["death_code"],
    )

    if args["dec_type"] == "DEC_CHILD":
        # Let's record informations related to the child
        report_dec_bebe = ReportDECBebe.objects.create(
            death_report=created_dec_report, concerned_child=args["concerned_child"]
        )
    ...
    if args["dec_type"] == "DEC_CHILD":
        ...
        args["info_to_supervisors"] = (
            ...
            + args["phone"]
            + "' ahejeje gutanga mesaje ivuga urupfu rw umwana '"
            + args["child_number"].child_code_designation
            + "' w umupfasoni '"
            + args["concerned_mother"].id_mother
            + "'."
    ...
    if args["dec_type"] == "DEC_WOMAN":
        ...
        args["info_to_contact"] = (
            "Mesaje ivuga urupfu rw umupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse"
        )
        args["info_to_supervisors"] = (
            "Umuremesha kiyago akoresha '"
            + args["phone"]
            + "' ahejeje gutanga mesaje ivuga urupfu rw umupfasoni '"
            + args["concerned_mother"].id_mother
            + "'"
        )
...
def modify_record_death_report(args):
    ...
    the_existing_dec_report = Report.objects.filter(
        mother=args["concerned_mother"], category=args["mot_cle"][0:3]
    )
    if len(the_existing_dec_report) < 1:
        ...
        args["info_to_contact"] = (
            "Ikosa. Nta raporo 'DEC' yumuvyeyi numero '"
            + args["concerned_mother"].id_mother
            + "' irabaho. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
    ...
    the_corresponding_dec_report = ReportDEC.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_dec_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'DEC' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    if args["dec_type"] == "DEC_CHILD":
        ...
        reports_dec_bebe = ReportDECBebe.objects.filter(
            death_report=the_one_corresponding_decreport
        )
        if len(reports_dec_bebe) < 1:
            ...
            one_corresponding_report_dec_bebe.death_report = (
                the_one_corresponding_decreport
            )
    ...
    if args["dec_type"] == "DEC_CHILD":
        ...
        args["info_to_contact"] = (
            "Mesaje ikosora iyari yatanzwe yerekeye urupfu rw umwana '"
            + args["child_number"].child_code_designation
            + "' w umupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse"
    ...
    if args["dec_type"] == "DEC_WOMAN":
        ...
        args["info_to_contact"] = (
            "Mesaje ikosora iyari yatanzwe yerekeye urupfu rw umupfasoni '"
            + args["concerned_mother"].id_mother
            + "' yashitse"
        )
        args["info_to_supervisors"] = (
...
def record_leave_report(args):
    ...
    args["info_to_contact"] = (
        "Mesaje ivuga ko umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yimutse yashitse neza"
    )
...
def modify_record_leave_report(args):
    ...
    if len(the_existing_dep_report) < 1:
        ...
        args["info_to_contact"] = (
            "Erreur. Aucun rapport trouve concernant la maman '"
            + args["concerned_mother"].id_mother
            + "'. Pour corriger, veuillez reenvoyer un message corrige et commencant par le mot cle "
            + args["mot_cle"]
        )
        return
    ...
    if the_only_one_corresponding_report.sub_hill != args["the_sender"].sub_colline:
        ...
        args["info_to_contact"] = (
            "Ikosa. Raporo yanyuma yumuvyeyi nomero '"
            + args["concerned_mother"].id_mother
            + "' ntiyavuye aho usanzwe ukorera. Mu gukosora, subira urungike iyo mesaje itangurwa na '"
            + args["mot_cle"]
            + "' yanditse neza"
        )
        return

    the_corresponding_dep_report = ReportDEP.objects.filter(
        report=the_only_one_corresponding_report
    )
    if len(the_corresponding_dep_report) < 1:
        ...
        args[
            "info_to_contact"
        ] = "Exception. Un rapport 'DEP' correspondant a la maman indiquee n est pas trouve. Veuillez contacter l administrateur du systeme"
        return
    ...
    args["info_to_contact"] = (
        "Mesaje ikosora iyari yatenzwe ivuga iyimuka ry umupfasoni '"
        + args["concerned_mother"].id_mother
        + "' yashitse neza"
    )
